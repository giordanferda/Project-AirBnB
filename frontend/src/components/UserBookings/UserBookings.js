          ...
          {bookings.map((booking) => (
            <div className="booking-card cardsforOwned" key={booking.id}>
              <div className="booking-card-left">
                <div
                  className="booking-card-right"
                  onClick={() => redirectUser(booking.Spot.id)}
                >
                  <img
                    className="Image"
                ...
                <div className="booking-card-info">
                  <h3 className="spotAddy-Owned spacing">
                    {booking.Spot.name}
                  </h3>
                ...
                <div className="booking-card-buttons">
                  <NavLink
                    ...
                    className="spacing booking-card-button"
                  >
                    View Spot
                  </NavLink>
                  <button
